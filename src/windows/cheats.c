...
static rct_widget window_cheats_guests_widgets[] = {
	...
	{ WWT_CLOSEBOX,			1,		XPL(1),					WPL(1),					YPL(19),		HPL(19),		STR_CHEAT_VOMIT,					STR_CHEAT_VOMIT_TIP },					// vomiting guests
	{ WIDGETS_END },
};
...
static uint64 window_cheats_page_enabled_widgets[] = {
	...
	(1ULL << WIDX_CLOSE) | (1ULL << WIDX_TAB_1) | (1ULL << WIDX_TAB_2) | (1ULL << WIDX_TAB_3) | (1ULL << WIDX_TAB_4) | (1ULL << WIDX_GUEST_PARAMETERS_GROUP) |
		...
		(1ULL << WIDX_GIVE_GUESTS_BALLOONS) | (1ULL << WIDX_GIVE_GUESTS_UMBRELLAS) | (1ULL << WIDX_TRAM_GUESTS) | (1ULL << WIDX_REMOVE_ALL_GUESTS) | (1ULL << WIDX_EXPLODE_GUESTS) | (1ULL << WIDX_VOMITING_GUESTS) |
...
static void window_cheats_guests_mouseup(rct_window *w, int widgetIndex)
{
	...
	case WIDX_EXPLODE_GUESTS:
		...
		break;
	case WIDX_VOMITING_GUESTS:
		game_do_command(0, GAME_COMMAND_FLAG_APPLY, CHEAT_VOMITGUESTS, 0, GAME_COMMAND_CHEAT, 0, 0);
		break;
