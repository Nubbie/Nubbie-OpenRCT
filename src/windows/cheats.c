...
static void window_cheats_rides_mouseup(rct_window *w, int widgetIndex)
{
	...
	case WIDX_SHOW_ALL_OPERATING_MODES:
		game_do_command(0, GAME_COMMAND_FLAG_APPLY, CHEAT_SHOWALLOPERATINGMODES, 0, GAME_COMMAND_UNSTABLE_CHEAT, 0, 0);
	...
	case WIDX_SHOW_VEHICLES_FROM_OTHER_TRACK_TYPES:
		game_do_command(0, GAME_COMMAND_FLAG_APPLY, CHEAT_SHOWVEHICLESFROMOTHERTRACKTYPES, 0, GAME_COMMAND_UNSTABLE_CHEAT, 0, 0);
	...
	case WIDX_ENABLE_ARBITRARY_RIDE_TYPE_CHANGES:
		game_do_command(0, GAME_COMMAND_FLAG_APPLY, CHEAT_ALLOW_ARBITRARY_RIDE_TYPE_CHANGES, 0, GAME_COMMAND_UNSTABLE_CHEAT, 0, 0);
